...
DRAM_GATE_WEIGHT_BASE = 0x80000000
DRAM_UP_WEIGHT_BASE = 0x80000400  # 1024 bytes after gate
DRAM_ACTIVATION_BASE = 0x80000800
DRAM_OUTPUT_BASE = 0x80000C00

# VMEM scratchpad layout
VMEM_GATE_WEIGHT_BASE = 0x20002000
VMEM_UP_WEIGHT_BASE = 0x20002400
VMEM_ACTIVATION_BASE = 0x20002800
VMEM_OUTPUT_BASE = 0x20002C00
