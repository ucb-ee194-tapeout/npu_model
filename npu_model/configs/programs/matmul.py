...
class MatmulProgram(Program):
    ...
    instructions: List[Instruction] = [
        Instruction(mnemonic="addi", args=ScalarArgs(rd=1, rs1=0, imm=VMEM_ACTIVATION_BASE)),
        Instruction(mnemonic="addi", args=ScalarArgs(rd=2, rs1=0, imm=VMEM_WEIGHT_BASE)),
