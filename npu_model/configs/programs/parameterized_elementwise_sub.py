...
Uses a hardware counted loop over all tiles.
...
_32_regions, _32_golden = _make_program(32, 32, seed=30)
...
_64_regions, _64_golden = _make_program(64, 64, seed=31)
...
_32x64_regions, _32x64_golden = _make_program(32, 64, seed=32)
